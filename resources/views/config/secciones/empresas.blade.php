    ...
    <div class="container-fluid bg-white py-5 rounded mb-5">
        <div class="row">
            <div class="col-12 d-flex justify-content-center align-items-center flex-column text-center">
                ...
                <form id="form_image_slider" action="{{ route('empresa.empresa.store') }}" method="POST"  class="file-upload mt-2" style="" enctype="multipart/form-data">
                    @csrf
        ...
        <div class="row mt-3">
            @forelse ($empresas as $empresa)
                <div class="col-3 mt-4 position-relative">
                    <div class="card border-0">
                        <div style="
                            background-image: url('{{ asset('img/photos/empresas/'.$empresa->imagen) }}');
                    ...
                    <div class="col position-absolute top-0 end-0">
                        <form action="{{ route('empresa.empresa.destroy', ['empresa' => $empresa->id]) }}" method="POST" enctype="multipart/form-data" id="form-{{ $empresa->id }}">
                            @csrf
                            @method('DELETE')
            ...
            @empty
                <div class="card w-100 text-center py-3">No hay imágenes en el empresa</div>
            @endforelse
        </div>
    </div>
